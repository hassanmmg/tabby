...
export declare function getHreflangLinks(common: CommonComposableOptions, locales: LocaleObject[], key: NonNullable<I18nHeadOptions['key']>, seo: I18nHeadOptions['seo']): MetaAttrs[];
...
export declare function getCanonicalQueryParams(common: CommonComposableOptions, seo: I18nHeadOptions['seo']): string | undefined;
